...
# genesisSupply = 520737576  || https://explorer.solar.org/blocks/e492f9d34df01238fda8bac79be19cb77656f444347d076a55811f909eb24e3a
...
bc -l <<< "scale=10; (((((($currentSupply - 520737576)) / $currentSupply)) * 100 * ((31557600 / (($currentUnixTs - 1648490400))))))"
echo ""